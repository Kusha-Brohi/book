...
Route::get('bookimage/{id}/delete', ['as' => 'bookimage.delete', 'uses' => 'LoggedInController@destroyBookImage']);
...
Route::get('blog-details/{slug}','HomeController@BlogDetail')->name('BlogDetail');
Route::get('book','HomeController@Book')->name('book');
Route::get('book-details/{slug}','HomeController@BookDetail')->name('bookDetail');
Route::get('story/{slug}','HomeController@Story')->name('story');
...
Route::get('/search-work', function () {
    return view('search-work_new');
});
Route::get('/shadow-of-robert-gray', function () {
    return view('shadow-of-robert-gray');
});
Route::get('/the-shoot-horses', function () {
    return view('the-shoot-horses');
});
Route::get('/the-spirit-of-the-tillamook-people', function () {
    
    return view('thespirit');
});
Route::get('/give-em-hell-harry', function () {
    return view('give-em-hell-harry');
});
Route::get('/rescue-from-the-rock', function () {
    return view('rescue-from-the-rock');
});

Route::get('/fortress-astoria', function () {
    return view('fortress-astoria');
});
//=================================================================//
...
Route::resource('admin/innerbanner', 'Admin\\InnerbannerController');
...
Route::resource('admin/story-image', 'Admin\\StoryImageController');
Route::resource('admin/storycontent', 'Admin\\StorycontentController');