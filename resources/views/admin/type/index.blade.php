    ...
    <div class="container-fluid bg-white mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Type</h3>
                    
                        <a class="btn btn-success pull-right" href="{{ url('/admin/type/create') }}"><i
                                    class="icon-plus"></i> Add Type</a>
                    ...
                    <div class="table-responsive">
                      <table id="myTable" class="table color-table table-bordered product-table table-hover">
                            ...
                            <tr>
                                <th>#</th>
                                <th>Name</th><th>Detail</th><th>Image</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($type as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td>{{ $item->name }}</td><td>{{ $item->detail }}</td><td>{{ $item->image }}</td>
                                    <td>
